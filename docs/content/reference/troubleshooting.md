...
Most of these come down to network reality or how deezer serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

deezer rate-limits like any public site. deezer already paces
...
Where a surface is gated, deezer reads a cookie or token you supply
...
`deezer`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what deezer actually did
